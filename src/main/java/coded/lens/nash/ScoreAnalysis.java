...
public class ScoreAnalysis {
    ...
    /*
     * This is an O(N) solution, a more stream style approach would be to use the Stream::sliding() function
     * But calculating that becomes N*windowSize (which is basically an O(N^2) solution).
     */
